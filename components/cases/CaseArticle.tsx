...
interface CaseArticleProps {
  post: CasePost;
  previousPost?: CasePost | null;
  nextPost?: CasePost | null;
}

export default function CaseArticle({ post, previousPost, nextPost }: CaseArticleProps) {
  return (
    <article className="mx-auto w-full max-w-[720px] px-5 pb-32 pt-12 md:px-8">
      ...
      {post.content && post.content.length > 0 ? (
        <CaseBlockRenderer blocks={post.content} />
      ) : (
