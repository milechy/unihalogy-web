...
import { getAllCases } from '@/content/cases/index';

interface RelatedCasesProps {
  currentPost: CasePost;
}

export default function RelatedCases({ currentPost }: RelatedCasesProps) {
  ...
  return (
    <section className="mt-16">
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link
          href={`/cases?category=${categoryParam}`}
